...
// TodoElectronica21 - Proyecto Santa Claus con árbol LED y música de Navidad
// Enlace al vídeo: https://www.youtube.com/watch?v=KZeq6vbdBdg

//Recomendación: Si no se entiende alguno de los pasos os recomiendo ver nuestros tutoriales del canal:
//Tutoriales de programación Arduino: https://www.youtube.com/playlist?list=PLVlQW76vGSm_PIo5F0B93TuLfPWJSdMVK
...
void loop() {
  ...
  delay(noteDelay * 1);
  Serial.println("");
  Serial.println("TodoElectronica21 os desea Feliz Navidad!!");
  Serial.println("");
  ...
  //Imprimimos mensaje final y esperamos 10 minutos (600000 milisegundos)
    ...
    Serial.println("Da LIKE y COMPARTE NUESTRO PROYECTO =) Muchas gracias !!!");
    Serial.println("");
    delay(600000);
    contador=0;
  }
  ...
  //Para más información visitar el canal de TodoElectronica21
  //En el siguiente enlace: https://www.youtube.com/channel/UCF8tmF0FBFvCOeuTcvqUVLA
